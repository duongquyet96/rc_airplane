void config_nrf_rx()
{
  ...
  write_reg(0x11,0x04);       //set rx payload 2 bytes
  ...
  attachInterrupt(0,get_data,FALLING);  //attach interrupt..when new data is avaialble nrf pulls down interrupt 0 pin of arduino and get_data() is called
  delay(20);
}
